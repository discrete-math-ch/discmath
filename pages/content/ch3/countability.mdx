...
<Problem title="This seems odd" difficulty={2} relevance={4} source="Tobias Steinbrecher">
  ...
  <div label="hint">
  First really understand the set. This is simply the se of functions, which maps each even natural number to $0$ and an odd natural number to some $0$ or $1$. Now think about how we could 
  </div>
  <div label="answer">
