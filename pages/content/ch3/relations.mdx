...
<Problem title="Number of transitive relations" difficulty="🐉" source="Tobias Steinbrecher">
<div label="question">  
...
<div label="answer">  
**Unsolved problem** 🙃
The number of transitive relations is a more complex counting problem. For $n$-element sets, the first couple of the known values of the number of transitive relations are:  
$$
