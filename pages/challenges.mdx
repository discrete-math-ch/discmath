...
The first student enrolled in Discrete Mathematics 2024 who sends a sophisticated proof to [submit@discmath.ch](mailto:submit@discmath.ch) will receive chocolate in the next exercise session (indicate which exercise session you will attend) - be honest and don't use external tools :). 
