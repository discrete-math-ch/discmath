...
<Problem label="Collatz Conjecture" source="Max Obreiter">
    <div label="question">
        The [Collatz Conjecture](https://en.wikipedia.org/wiki/Collatz_conjecture) states that for any positive integer $n$, the following sequence will eventually reach 1:
        $$
        x_{n + 1} = \begin{cases}
        ...
        **Reflexive**: Let $a \in A$ be arbitrary but fixed:
        $$
            \begin{aligned}
                ...
                \dimplies & (a, a) \in (\rho \cap \sigma) && \text{Def. $\cap$} \\
            \end{aligned}
        $$
        ...
        **Symmetric**: Let $a, b \in A$ be arbitrary but fixed:
        $$
            \begin{aligned}
                ...
                \dimplies & (a, b) \in \rho \land (a, b) \in \sigma && \text{Def. $\cap$} \\
                \dimplies & (b, a) \in \rho \land (b, a) \in \sigma && \rho, \sigma \text{ are symmetric} \\
                \dimplies & (b, a) \in (\rho \cap \sigma) && \text{Def. $\cap$} \\
            \end{aligned}
        $$
        ...
        **Transitive**: Let $a, b, c \in A$ be arbitrary but fixed:
        $$
            \begin{aligned}
                ...
                \dimplies & (a, b) \in \rho \land (a, b) \in \sigma \land (b, c) \in \rho \land (b, c) \in \sigma && \text{Def. $\cap$} \\
                \dimplies & (a, b) \in \rho \land (b, c) \in \rho \land (a, b) \in \sigma \land (b, c) \in \sigma && \text{Commutativity of $\land$} \\
                \dimplies & (a, c) \in \rho \land (a, c) \in \sigma && \rho, \sigma \text{ are transitive} \\
                \dimplies & (a, c) \in (\rho \cap \sigma) && \text{Def. $\cap$} \\
            \end{aligned}
        $$
...
<Problem title="Equivalence Relation on Vector Spaces" source="Tobias Steinbrecher" difficulty="🐺">
  ...
  <div label="answer">
    This is an unsolved choclate challenge problem! Check [Challenges](/challenges) for more information.
  </div> 
</Problem>
