...
The first student enrolled in Discrete Mathematics 2024 who sends a sophisticated proof to `submit [at] discmath [dot] ch` will receive chocolate in the next exercise session (indicate which exercise session you will attend, you can obsviously try any challenge you like :)) - be honest and don't use external tools :). 
