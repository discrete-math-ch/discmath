...
const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR6bXluZXl6aml4Zm1pZmRkYXlpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjc4ODY2NTcsImV4cCI6MjA0MzQ2MjY1N30.wHiXIV3ncrUha1xVtNbZdsjcS6UmJZy2DyYSe1gzulQ";
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col mt-5">
      <textarea
        ...
        required
      ></textarea>
      <button className="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 dark:bg-blue-700 dark:hover:bg-blue-900 dark:focus:ring-blue-600">
        Submit
      </button>
    </form>
  );
