...
The first student enrolled in Discrete Mathematics 2024 who sends a sophisticated proof to `submit [at] discmath [dot] ch` will receive chocolate in the next exercise session (indicate which exercise session you will attend, you can obviously try any challenge you like :)) - be honest and don't use external tools :). 
...
<Problem title="Two be or not two be" difficulty={5} relevance={0} source="Yannick Funke, Max Obreiter">
    <div label="question">
        *Prove the following statement*:
        ...
        - Proof by Induction
        - Results from Chapter 4 and 5 unless explicitly allowed
    ...
    <div label="answer">
        ...
        Now we prove that for any fixed but arbitrary natural number $n \in \mathbb N$ the following holds:
        $$
