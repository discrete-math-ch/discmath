...
- Tobias Steinbrecher `tsteinbreche [at] ethz [dot] ch`
- Yannick Funke `yfunke [at] ethz [dot] ch`
- Max Obreiter `mobreiter [at] ethz [dot] ch` 
- Philipp Barski `pbarski [at] ethz [dot] ch`


*It is now being maintained by teaching assistants for the 2025 edition of the course.*
- Hatim Abdel Ghaffar `habdel [at] ethz [dot] ch`
- Leo Chen `chenleo [at] ethz [dot] ch` 
- Hannah Oss `hanoss [at] ethz [dot] ch`
- Leo Schmidt-Traub `leoschmidt [at] ethz [dot] ch`
- Shivram Shambus `dm [at] shivi [dot] io`
- Emil Straschil `estraschil [at] ethz [dot] ch`
