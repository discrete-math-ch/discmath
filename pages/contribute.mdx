...
- **Description**: Represents the difficulty level of the problem. Accepts an integer from `1` to `6`, which displays as an animal emoji to provide a visual indicator of difficulty:
  - 1 🐣 (Easy)
  - 2 🐢 (Fairly Easy)
  - 3 🐱 (Moderate)
  - 4 🐺 (Hard)
